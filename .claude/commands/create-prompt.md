...
**Steps**
1. If invoked as `/create-prompt $Arguments`, treat `$Arguments` as the draft prompt: analyze it, call out missing info (domain, output type, constraints, audience, style, tool usage), and ask only essential clarifying questions.
2. If invoked as `/create-prompt` with no arguments, immediately ask: "What is your objective or goal for this prompt?"
